      ...
      $accounts = json_decode(file_get_contents('accounts.json'),1);
			if(isset($update->message)){
              ...
              $bot->sendphoto([ 'chat_id'=>$chatId,
                  'photo'=>"https://t.me/AAALLLB",
                   'caption'=>'My Ch : @AAABBBLB',
                  'reply_markup'=>json_encode([
                      'inline_keyboard'=>[
                          [['text'=>'اضافة حساب ☃️','callback_data'=>'login']],
                       [['text'=>"Dev", 'url'=>"https://t.me/AAABBBLB"]],
                      ]
                  ])
              ]);   
          } 
if($text == '/help'){
              ...
              'video'=>"https://t.me/AAABBBLB",
              'caption'=>'طرق السحبب🤘😂',
                      'reply_markup'=>json_encode([
                      'inline_keyboard'=>[                       
                       [['text'=>"𝙍𝙚𝙥𝙤𝙧𝙩 𝙋𝙧𝙤𝙗𝙡𝙚𝙢𝙨", 'url'=>"https://t.me/AAABBBLB"]],
                       ]
                       ])
                       ]);
    
              $bot->sendvoice([ 'chat_id'=>$chatId,
                  'voice'=>"https://t.me/AAABBBLB",
          		...
          		if($mode == 'addL'){
          			...
          			if(isset($body->message)){
          				...
          				$keyboard = ['inline_keyboard'=>[
										[['text'=>"اضافة حساب ☃️جديد 👨🏻‍💻",'callback_data'=>'addL']]
									]];
          		  ...
          		  if(is_numeric($text)){
                      ...
                      'chat_id'=>$chatId,
                      'message_id'=>$mid,
                      'text'=>"control panal ✔️✔️~ @AAALLLB",
                  'reply_markup'=>json_encode([
                      'inline_keyboard'=>[
                          [['text'=>'اضافة حساب ☃️👨🏻‍💻','callback_data'=>'login']],
                          [['text'=>'طرق السحب ☄️☄️','callback_data'=>'grabber']],
...
اضغط في الاسفل لمراسله المطور 👇",
          ...
          if($data == 'login'){
            ...
            $bot->editMessageText([
                ...
                'reply_markup'=>json_encode([
                    'inline_keyboard'=>[
                        [['text'=>'بحث كلمات 🕶️','callback_data'=>'search']],
