                    ...
                    if(checkMail($mail)){
                        ...
                        if ($inInsta !== false) {
                            // if($config['filter'] <= $follow){
                                ...
                                $following = $info['ff'];
                                $media = $info['m'];
                                bot('sendMessage', ['disable_web_page_preview' => true, 'chat_id' => $id, 'text' => "Hi New Acc ~ @shakirskinny\n━━━━━━━━━━━━\n*🌡️🌡️ UserName :* [$usern](instagram.com/$usern)\n*🌡️🌡️ Email :* [$mail]\n*🌡️🌡️ Followers :* $follow\n*🌡️🌡️ Following :* $following\n*🌡️🌡️ Post :* $media\n━━━━━━━━━━━━\n*Ch :* [@AAABBBLB]\n*By :* [@AAALLLB]",
